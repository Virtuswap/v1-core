...
//         // A/C : 100/400
//         // B/C : 200/400 (A-2B)
//         address ikPool = IvPairFactory(factory).getPair(tokenA, tokenB);
//         address jkPool = IvPairFactory(factory).getPair(tokenC, tokenB);
...
//         uint256 amountOutA = IvRouter(router).getVirtualAmountOut(
//             jkPair,
//             ikPair,
//             reserveBalance
//         );
